/**************************************************************************************************************
* Procedure:    Get Accounting File (RDA)
* PURPOSE:      Produces the extract for the TDC Accounting File from RDA
* NOTES:
* TEST: 
* Created:      05/07/2013
*
...
Select  c.Cust_MerchantID As Merchant_Id
...
From    dbo.ca_Loan_Appl la WITH (NOLOCK) Inner Join 
        dbo.ca_Customer c WITH (NOLOCK) On la.Cust_Id = c.Cust_Id Inner Join 
        dbo.ca_User u WITH (NOLOCK) On c.Cust_MerchantID = u.Merch_Id Left Join 
        dbo.ca_Collections co WITH (NOLOCK) On la.Appl_No = co.Appl_No Left Join 
        dbo.ca_ACH_Processed ap WITH (NOLOCK) ON la.Appl_no = ap.Appl_No And ap.Tran_Code = '22' And ap.ACH_For = 'C' AND ap.ACH_Code = 'SND' AND ap.ACH_Sent_Status = 'S' AND ap.IsDeleted = 0 Left Join 
...
From    dbo.ca_Loan_Appl la WITH (NOLOCK) Inner Join 
        ...
        dbo.ca_Collections co WITH (NOLOCK) On la.Appl_No = co.Appl_No Left Join 
        dbo.ca_ACH_Processed ap WITH (NOLOCK) ON la.Appl_no = ap.Appl_No And ap.Tran_Code = '22' And ap.ACH_For = 'C' AND ap.ACH_Code = 'SND' AND ap.ACH_Sent_Status = 'S' AND ap.IsDeleted = 0 Left Join 
        dbo.ca_User ou WITH (NOLOCK) On c.Cust_MerchantID = ou.Merch_Id AND ou.User_ID = la.origin_user Left Join 
...
If @IsCSO = 1
 Begin
    ...
    From    dbo.ca_Loan_Appl la WITH (NOLOCK) Inner Join 
            dbo.ca_Customer c WITH (NOLOCK) On la.Cust_Id = c.Cust_Id Inner Join 
            dbo.ca_User u WITH (NOLOCK) On c.Cust_MerchantID = u.Merch_Id Inner Join 
            dbo.ca_RateMaster r WITH (NOLOCK) ON la.RateID = r.RateID AND CSOType = 1 Left Join 
            dbo.ca_Collections co WITH (NOLOCK) On la.Appl_No = co.Appl_No Left Join 
            dbo.ca_ACH_Processed ap WITH (NOLOCK) ON la.Appl_no = ap.Appl_No And ap.Tran_Code = '22' And ap.ACH_For = 'C' AND ap.ACH_Code = 'SND' AND ap.ACH_Sent_Status = 'S' AND ap.IsDeleted = 0 Left Join 
            dbo.ca_User ou WITH (NOLOCK) On c.Cust_MerchantID = ou.Merch_Id AND ou.User_ID = la.origin_user
...
From    dbo.ca_Void v WITH (NOLOCK) Inner Join 
        dbo.ca_Loan_Appl la WITH (NOLOCK) On v.Void_No = la.Appl_No Inner Join 
        dbo.ca_Customer c WITH (NOLOCK) On la.Cust_Id = c.Cust_Id Inner Join 
        dbo.ca_User u WITH (NOLOCK) On c.Cust_MerchantID = u.Merch_Id Left Join 
        dbo.ca_Collections co WITH (NOLOCK) On la.Appl_No = co.Appl_No Left Join 
        dbo.ca_ACH_Processed ap WITH (NOLOCK) ON la.Appl_no = ap.Appl_No  And ap.Tran_Code = '22' And ap.ACH_For = 'C' AND ap.ACH_Code = 'SND' AND ap.ACH_Sent_Status = 'S' AND ap.IsDeleted = 0 Left Join 
...
Where   v.Date_Created  >= @minDate And 
...
From    dbo.ca_Void v WITH (NOLOCK) Inner Join 
        ...
        dbo.ca_Collections co WITH (NOLOCK) On la.Appl_No = co.Appl_No Left Join 
        dbo.ca_ACH_Processed ap WITH (NOLOCK) ON la.Appl_no = ap.Appl_No  And ap.Tran_Code = '22' And ap.ACH_For = 'C' AND ap.ACH_Code = 'SND' AND ap.ACH_Sent_Status = 'S' AND ap.IsDeleted = 0 Left Join 
        dbo.ca_User ou WITH (NOLOCK) On c.Cust_MerchantID = ou.Merch_Id AND ou.User_ID = la.origin_user Inner Join 
...
From    dbo.ca_Payment p WITH (NOLOCK) Inner Join 
        dbo.ca_Loan_Appl la WITH (NOLOCK) On p.Appl_No = la.Appl_No Inner Join 
        dbo.ca_Customer c WITH (NOLOCK) On la.Cust_Id = c.Cust_Id Inner Join 
        dbo.ca_User u WITH (NOLOCK) On c.Cust_MerchantID = u.Merch_Id Left Join 
        dbo.ca_Payment p2 WITH (NOLOCK) On p.Refno = p2.Pmt_Tran_No Left Join 
        dbo.ca_ACH_Processed ap WITH (NOLOCK) ON ap.Pmt_No = p2.Pmt_Tran_No AND ap.IsDeleted = 0 Left Join 
        dbo.ca_Collections co WITH (NOLOCK) On la.Appl_No = co.Appl_No Left Join 
        dbo.ca_User ou WITH (NOLOCK) On c.Cust_MerchantID = ou.Merch_Id AND ou.User_ID = la.origin_user

Where   p.Date_Created  >= @minDate And 
...
Where   p.Date_Created  >= @minDate And 
        ...
        la.Merch_Store_ID like @MerchantNo + '%' And 
        ISNULL(@StoreNo,la.Merch_Store_Id) = la.Merch_Store_Id And 
        isNULL ( p.latecharge_Paid, 0 ) + isNULL ( p.Othcharge_Paid, 0 ) + isNULL ( p.Feecharge_Paid, 0 ) <> 0 And 
        la.User_Id = u.User_Id;

 --Assessments/Waive interest
--11/26/2012 ADDING Filter for only intcalc_Typecode = 'A', as per Joe negative amount should not be in o/p
...
From    dbo.ca_Payment p WITH (NOLOCK) Inner Join 
        dbo.ca_interest_Calc ic WITH (NOLOCK) On p.Pmt_Tran_No = ic.Pmt_Tran_No Inner Join 
        dbo.ca_Loan_Appl la WITH (NOLOCK) On p.Appl_No = la.Appl_No Inner Join 
        dbo.ca_Customer c WITH (NOLOCK) On la.Cust_Id = c.Cust_Id Inner Join 
        dbo.ca_User u WITH (NOLOCK) On c.Cust_MerchantID = u.Merch_Id Left Join 
        dbo.ca_Payment p2 WITH (NOLOCK) On p.Refno = p2.Pmt_Tran_No Left Join 
...
From    dbo.ca_Bankruptcy_charges bc WITH (NOLOCK) Inner Join 
        dbo.ca_Loan_Appl la WITH (NOLOCK) On bc.Appl_No = la.Appl_No Inner Join 
        dbo.ca_Customer c WITH (NOLOCK) On la.Cust_Id = c.Cust_Id Inner Join 
        dbo.ca_User u WITH (NOLOCK) On c.Cust_MerchantID = u.Merch_Id Left Join 
        dbo.ca_Collections co WITH (NOLOCK) On la.Appl_No = co.Appl_No Left Join 
        dbo.ca_User ou WITH (NOLOCK) On c.Cust_MerchantID = ou.Merch_Id AND ou.User_ID = la.origin_user

Where   bc.Date_Created  >= @minDate And 
...
--Processed Ach Fifth
Insert Into @DailyAccountingReport
Select  Left ( ap.Store_No, 5 ) As Merchant_Id
...
From    dbo.ca_Ach_Processed ap WITH (NOLOCK) Left Join 
        dbo.ca_Loan_Appl la WITH (NOLOCK) On la.Appl_No = ap.Appl_No Left Join 
        dbo.ca_Customer c WITH (NOLOCK) On la.Cust_Id = c.Cust_Id Left Join 
        dbo.ca_User u WITH (NOLOCK) On c.Cust_MerchantID = u.Merch_Id  And la.User_Id = u.User_Id Left Join 
        dbo.ca_User ou WITH (NOLOCK) On c.Cust_MerchantID = ou.Merch_Id AND ou.User_ID = la.origin_user

Where   ap.Ach_Sent_Time  >= @minDate And 
...
--Petty Cash Sixth
Insert Into @DailyAccountingReport
Select  Left ( pct.Store_Id, 5 ) As Merchant_Id
...
Insert Into @DailyAccountingReport
Select  Left ( Merch_Store_ID, 5) AS Merchant_ID
...
-------------------------*/
Insert Into @DailyAccountingReport
Select  Left ( ck.StoreID, 5) AS Merchant_ID
...
--Cash In Out
Insert Into @DailyAccountingReport
Select  Left ( c.StoreID, 5) AS Merchant_ID
...
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   co.Assigned_User_ID As Assigned_Collector
    ,   u.Merchant_UserID As Emp_User_ID
    ,   lah.DateCreated As Tran_Date_Time
    ,   lah.applno As Tran_Id
    ,   lah.applno As Tran_Lynk_Id
    ,   'tran_Type_Id' = Case
                            when lah.newprinciplebalance - lah.oldprinciplebalance > 0 and lah.oldloanstatus in ('N','O') then '90'
                            when lah.newprinciplebalance - lah.oldprinciplebalance > 0 and lah.oldloanstatus = 'R' then '91'
                            when lah.newprinciplebalance - lah.oldprinciplebalance > 0 and lah.oldloanstatus = 'C' then '92'
                            when lah.newprinciplebalance - lah.oldprinciplebalance > 0 and lah.oldloanstatus = 'B' then '93'
                            when lah.newprinciplebalance - lah.oldprinciplebalance > 0 and lah.oldloanstatus = 'G' then '94'
                            when lah.newprinciplebalance - lah.oldprinciplebalance < 0 and lah.oldloanstatus in ('N','O') then '95'
                            when lah.newprinciplebalance - lah.oldprinciplebalance < 0 and lah.oldloanstatus = 'R' then '96'
                            when lah.newprinciplebalance - lah.oldprinciplebalance < 0 and lah.oldloanstatus = 'C' then '97'
                            when lah.newprinciplebalance - lah.oldprinciplebalance < 0 and lah.oldloanstatus = 'B' then '98'
                            when lah.newprinciplebalance - lah.oldprinciplebalance < 0 and lah.oldloanstatus = 'G' then '99'
                            Else 23
                        End
    ,   '' As Tran_Mode
    ,   lah.newprinciplebalance - lah.oldprinciplebalance as Total_Amount_Of_Transaction
    ,   1 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
From    dbo.ca_loanapplicationhistory lah WITH (nolock) Inner Join 
        dbo.ca_Loan_Appl la WITH (NOLOCK) On lah.ApplNo = la.Appl_No Inner Join 
        dbo.ca_Customer c WITH (NOLOCK) On la.Cust_Id = c.Cust_Id Inner Join 
        dbo.ca_User u WITH (NOLOCK) On c.Cust_MerchantID = u.Merch_Id Left Join 
        dbo.ca_Collections co WITH (NOLOCK) On la.Appl_No = co.Appl_No Left Join 
        dbo.ca_User ou WITH (NOLOCK) On c.Cust_MerchantID = ou.Merch_Id AND ou.User_ID = la.origin_user

Where   lah.DateCreated  >= @minDate And 
        lah.DateCreated < @maxDate And 
        la.Merch_Store_ID like @MerchantNo + '%' And 
        ISNULL(@StoreNo,la.Merch_Store_Id) = la.Merch_Store_Id And 
        la.User_Id = u.User_Id and 
        lah.recordstatusid = '1' and 
        lah.oldloanstatus = lah.newloanstatus and 
        lah.oldloanstatus in ('N','O','R','C','B','G') and 
        lah.oldprinciplebalance - lah.Newprinciplebalance <> 0;
...
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   lah.applno As Tran_Lynk_Id
    ,   'tran_Type_Id' = Case
                            when lah.NewfinchgBalance - lah.oldfinchgBalance > 0 and lah.oldloanstatus in ('N','O') then '90'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance > 0 and lah.oldloanstatus = 'R' then '91'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance > 0 and lah.oldloanstatus = 'C' then '92'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance > 0 and lah.oldloanstatus = 'B' then '93'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance > 0 and lah.oldloanstatus = 'G' then '94'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance < 0 and lah.oldloanstatus in ('N','O') then '95'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance < 0 and lah.oldloanstatus = 'R' then '96'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance < 0 and lah.oldloanstatus = 'C' then '97'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance < 0 and lah.oldloanstatus = 'B' then '98'
                            when lah.NewfinchgBalance - lah.oldfinchgBalance < 0 and lah.oldloanstatus = 'G' then '99'
                            Else 23
                        End
    ,   '' As Tran_Mode
    ,  lah.NewfinchgBalance - lah.oldfinchgBalance as Total_Amount_Of_Transaction
    ,   2 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
Where   lah.DateCreated  >= @minDate And 
        ...
        lah.oldloanstatus = lah.newloanstatus and 
        lah.oldloanstatus in ('N','O','R','C','B','G') and 
        lah.oldfinchgBalance - lah.newfinchgBalance <> 0;
...
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   lah.applno As Tran_Lynk_Id
    ,   'tran_Type_Id' = Case
                            when lah.newfeebalance - lah.oldfeebalance > 0 and lah.oldloanstatus in ('N','O') then '90'
                            when lah.newfeebalance - lah.oldfeebalance > 0 and lah.oldloanstatus = 'R' then '91'
                            when lah.newfeebalance - lah.oldfeebalance > 0 and lah.oldloanstatus = 'C' then '92'
                            when lah.newfeebalance - lah.oldfeebalance > 0 and lah.oldloanstatus = 'B' then '93'
                            when lah.newfeebalance - lah.oldfeebalance > 0 and lah.oldloanstatus = 'G' then '94'
                            when lah.newfeebalance - lah.oldfeebalance < 0 and lah.oldloanstatus in ('N','O') then '95'
                            when lah.newfeebalance - lah.oldfeebalance < 0 and lah.oldloanstatus = 'R' then '96'
                            when lah.newfeebalance - lah.oldfeebalance < 0 and lah.oldloanstatus = 'C' then '97'
                            when lah.newfeebalance - lah.oldfeebalance < 0 and lah.oldloanstatus = 'B' then '98'
                            when lah.newfeebalance - lah.oldfeebalance < 0 and lah.oldloanstatus = 'G' then '99'
                            Else 23
                        End
    ,   '' As Tran_Mode
    ,   lah.newfeebalance - lah.oldfeebalance as Total_Amount_Of_Transaction
    ,   3 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
Where   lah.DateCreated  >= @minDate And 
        ...
        lah.oldloanstatus = lah.newloanstatus and 
        lah.oldloanstatus in ('N','O','R','C','B','G') and 
        lah.oldfeebalance - lah.newfeebalance <> 0;

/*--------------------------------------
--Manual Loan Status Changes
---------------------------------------*/
--Principal old
Insert Into @DailyAccountingReport
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   lah.applno As Tran_Lynk_Id
    ,   'tran_Type_Id' = Case
                            when lah.oldloanstatus in ('N','O') then '80'
                            when lah.oldloanstatus = 'R' then '81'
                            when lah.oldloanstatus = 'C' then '82'
                            when lah.oldloanstatus = 'B' then '83'
                            when lah.oldloanstatus = 'G' then '84'
                            Else 23
                        End
    ,   '' As Tran_Mode
    ,  lah.oldprinciplebalance * -1 as Total_Amount_Of_Transaction
    ,   1 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
Where   lah.DateCreated  >= @minDate And 
        ...
        la.User_Id = u.User_Id and 
        lah.recordstatusid = '1' and 
        lah.oldloanstatus <> newloanstatus and 
        lah.oldloanstatus in ('N','O','R','C','B','G') and 
        lah.oldprinciplebalance <> 0;
...
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   'tran_Type_Id' = Case
                        ...
                        End
    ,   '' As Tran_Mode
    ,  lah.oldfinchgBalance * -1 as Total_Amount_Of_Transaction
    ,   2 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   'tran_Type_Id' = Case
                        ...
                        End
    ,   '' As Tran_Mode
    ,  lah.oldfeebalance * -1 as Total_Amount_Of_Transaction
    ,   3 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   lah.applno As Tran_Lynk_Id
    ,   'tran_Type_Id' = Case
                            when lah.newloanstatus in ('N','O') then '85'
                            when lah.newloanstatus = 'R' then '86'
                            when lah.newloanstatus = 'C' then '87'
                            when lah.newloanstatus = 'B' then '88'
                            when lah.newloanstatus = 'G' then '89'
                            Else 23
                        End
    ,   '' As Tran_Mode
    ,   lah.newprinciplebalance as Total_Amount_Of_Transaction
    ,   1 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
Where   lah.DateCreated  >= @minDate And 
        ...
        lah.recordstatusid = '1' and 
        lah.oldloanstatus <> newloanstatus and 
        lah.newloanstatus in ('N','O','R','C','B','G') and 
        lah.Newprinciplebalance <> 0;
...
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   'tran_Type_Id' = Case
                        ...
                        End
    ,   '' As Tran_Mode
    ,  lah.newfinchgBalance as Total_Amount_Of_Transaction
    ,   2 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
Select  c.Cust_MerchantID As Merchant_Id
    ...
    ,   'tran_Type_Id' = Case
                        ...
                        End
    ,   '' As Tran_Mode
    ,  lah.newfeebalance as Total_Amount_Of_Transaction
    ,   3 As Tran_Account
    ,   NULL As Fee_Type
    ,   NULL As Loan_Disburse_Subtype
    ,   NULL As Payment_Sub_Type
...
------------------------------------
 Begin
    Select  ISNULL(dar.Merchant_Id,'') As Merchant_Id
        ...
        ,   Convert(varchar,ISNULL(OC_CollectionDate,'1/1/1900'),101) + ' '+
                Convert(varchar,ISNULL(OC_CollectionDate,'1/1/1900'),108) As OC_CollectionDate
        ,   ISNULL(Assigned_Collector,'') As Assigned_Collector
        ,   ISNULL(Emp_User_Id,'') As Emp_User_Id
        ,   Convert(varchar,ISNULL(Tran_Date_Time,'1/1/1900'),101) + ' '+
                Convert(varchar,ISNULL(Tran_Date_Time,'1/1/1900'),108) As Tran_Date_Time
        ,   Convert(varchar,GetDate(),101) + ' '+
                Convert(varchar,GetDate(),108) As Report_Date
